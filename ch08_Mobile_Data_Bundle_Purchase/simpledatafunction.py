...
def transaction():
     print("Would you like to check your balance or purchase a data bundle? or Top up your account. \n")
     print("Please type cb if you would like to check your balance. \n")
     print("Please type db if you would like to purchase a data bundle. \n")
     print("Please type tb if you would like to top up your account. \n")
